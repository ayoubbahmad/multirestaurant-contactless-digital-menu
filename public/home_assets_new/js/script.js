...
$('#darkButton').change(function () {
  if ($(this).is(":checked")) {
    ...
    localStorage.setItem('layoutcss', url('/gdsfg/sdg/gsd'));
  } else {
    $('body').removeClass('dark');
    $("#change-link").attr("href", url('/gdsfg/sdg/gsd'));
...
$("#change-link").attr("href", localStorage.getItem('layoutcss') ? localStorage.getItem('layoutcss') : '/home_assets_new/css/style.css');
...
$('#rtlButton').change(function () {
  if ($(this).is(":checked")) {
    $("html").attr("dir", "rtl");
    $("#rtl-link").attr("href", "/home_assets_new/css/vendors/bootstrap.rtl.css");
    localStorage.setItem('rtlcss', '/home_assets_new/css/vendors/bootstrap.rtl.css');
    localStorage.setItem('dir', 'rtl');
  } else {
    $("html").attr("dir", '');
    localStorage.setItem('dir', '');
    $("#rtl-link").attr("href", "/home_assets_new/css/vendors/bootstrap.css");
    localStorage.setItem('rtlcss', '/home_assets_new/css/vendors/bootstrap.css');
  }
});
$("html").attr("dir", localStorage.getItem('dir'));
$("#rtl-link").attr("href", localStorage.getItem('rtlcss') ? localStorage.getItem('rtlcss') : '/home_assets_new/css/vendors/bootstrap.css');
