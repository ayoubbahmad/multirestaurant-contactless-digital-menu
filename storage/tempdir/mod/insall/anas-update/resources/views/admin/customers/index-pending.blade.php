...
@section('title','Pending Customer')
@section('content')
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="col-lg-12 order-tab">
                                        <a href="{{ url('admin/customers/') }}" class="btn btn-light rounded-pill btn-sm btn-order-tab mr-1"><i class="ri-alert-line"></i>Active Customers</a>
                                        <a href="{{ url('admin/customers/pending') }}" class="btn btn-primary rounded-pill btn-sm btn-order-tab mr-1"><i class="ri-alert-line"></i>Pending Verification</a>
                                    ...
                                    <div class="table table-responsive">
                                        <table class="table" id="datatable">
                                            ...
                                            <tr>
                                                ...
                                                <th scope="col"><label class="text-muted mb-0">Action</label></th>
...
<script>
                $(document).ready(function () {
                    $('#datatable').DataTable({
                        ...
                        processing: true,
                        serverSide: true,
                        ajax: "{{ url('admin/customers/pending') }}",
                        columns: [
