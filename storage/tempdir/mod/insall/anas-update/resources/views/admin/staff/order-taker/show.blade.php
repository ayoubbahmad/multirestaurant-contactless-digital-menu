                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="col-lg-12 order-tab p-2">
                                        <a href="{{ url('admin/staffs/order-takers/show/'.$user->id)}}" class="btn btn-light active rounded-pill btn-sm btn-order-tab mr-1"><i class="ri-alert-line"></i>Previous Orders</a>
                                        <a href="{{ url('admin/staffs/order-takers/show-payment/'.$user->id)}}" class="btn btn-light rounded-pill btn-sm btn-order-tab mr-1"><i class="ri-alert-line"></i>Payment Collection</a>
                                    </div>
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                            @php
                                             $orders = App\Order::where('order_taker_id',$user->id)->latest()->paginate(5);
                                             @endphp
                                            @php
                                                $i = 1;
                                            @endphp
                                            ...
                                            <tr>
                                                ...
                                                <td><span class="font-weight-bold">{{ $row->store_name }}</span></td>
