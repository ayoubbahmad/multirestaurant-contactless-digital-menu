                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="col-lg-12 order-tab">
                                        ...
                                        <a href="{{ url('admin/orders/cancelled') }}" class="btn btn-primary rounded-pill btn-sm btn-order-tab mr-1"><i class="ri-alert-line"></i>Cancelled</a>
                                    </div>
...
<script>
                $(document).ready(function () {
                    $('#datatable').DataTable({
                        ...
                        processing: true,
                        serverSide: true,
                        ajax: "{{ url('admin/orders/cancelled') }}",
                        columns: [
