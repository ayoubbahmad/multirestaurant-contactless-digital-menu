                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="col-lg-12 order-tab">
                                        ...
                                        <a href="{{ url('admin/orders/processing') }}" class="btn btn-light rounded-pill btn-sm btn-order-tab mr-1"><i class="ri-alert-line"></i>Processing</a>
                                        <a href="{{ url('admin/orders/partially-completed') }}" class="btn btn-primary rounded-pill btn-sm btn-order-tab mr-1"><i class="ri-alert-line"></i>Partially Completed</a>
...
<script>
                $(document).ready(function () {
                    $('#datatable').DataTable({
                        ...
                        processing: true,
                        serverSide: true,
                        ajax: "{{ url('admin/orders/partially-completed') }}",
                        columns: [
